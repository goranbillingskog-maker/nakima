  ...
  head: () => ({
    meta: [
      ...
      { property: "og:title", content: "Nakima – hitta naprapat, kiropraktor & massör nära dig" },
      {
        ...
        content:
          "Sveriges redaktionella guide till manuell medicin. Hitta rätt terapeut och läs kunniga hälsoartiklar.",
      },
        ...
        children: JSON.stringify({
          ...
          "@graph": [
            ...
            },
            {
              ...
              potentialAction: {
                "@type": "SearchAction",
                target: "/naprapat/stockholm?q={search_term_string}",
